...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: "Enter your Twitter username (without the @)",
      fieldset: "social"
    }),
    ...
    defineField({
      ...
      type: "url",
      title: "Metadata Base",
      description: "The base URL for metadata generation",
      validation: Rule =>
        Rule.custom(
          (value, context) =>
            value &&
            ...
            new URL(value).origin ===
              (process.env.NEXT_PUBLIC_URL || "https://blog.lurnex.net").origin
              ? true
              : "The URL must be a valid absolute URL and match the NEXT_PUBLIC_URL"
        )
    })
  ]
});
