...
export default function PostList({
  ...
  return (
        ...
        <div className="flex flex-col h-full bg-white hover:bg-[#f3faff] rounded-2xl shadow-md hover:shadow-lg transition-shadow overflow-hidden p-0 max-w-sm transition-all duration-300 hover:scale-105">
          ...
          <div className="flex flex-col flex-1 p-5">
            ...
            {/* Title */}
            <h2
              className="text-lg font-semibold text-gray-900 leading-snug mb-2 line-clamp-3"
              style={{
                display: '-webkit-box',
                WebkitLineClamp: 3,
            ...
            {/* Author & Date */}
            <div className="flex items-center space-x-3 text-gray-500 text-sm mt-auto">
              {authorSlug && (
